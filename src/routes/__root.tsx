...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Amrok Supermarché — Pointage du personnel" },
      {
        name: "description",
        content:
          "Pointage des arrivées et départs des employés d'Amrok Supermarché, avec suivi des heures pour la direction.",
      },
